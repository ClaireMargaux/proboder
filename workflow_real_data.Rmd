...
noise_obs <- 30 # noise of observations
l <- 40 # lengthscale
noise_wiener_X <- 5 # noise of the Wiener process associated with X
...
noise_obs <- 50 # noise of observations
l <- 5 # lengthscale
noise_wiener_X <- 0.001 # noise of the Wiener process associated with X
noise_wiener_U <- 0.1 # noise of the Wiener process associated with U
beta0 = 0.8 # starting transmission rate
beta0prime <- 0 # starting 1st derivative of transmission rate
jit <- 10 # value for jitter on innovation covariance
