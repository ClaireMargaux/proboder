...
#' Plot simulated compartment counts and observations.
#'
#' This function generates a plot of the simulated compartment counts and observations.
#'
...
#' @export
plot_sim <- function(obs, obs_with_noise) {
